...
namespace ZVK
{
	...
	public:
		...
		// There is no crossproduct for 4D Vectors so just return a Vec3 and ignore w
		Vector3f CrossProduct(const Vector4f& rhs)
		{
			/*
			*        x y z
			*   this 1 2 3
	...
	public:
		...
		// There is no crossproduct for 4D Vectors so just return a Vec3 and ignore w
		Vector3i CrossProduct(const Vector4i& rhs)
		{
			/*
			*        x y z
			*   this 1 2 3
	...
	public:
		...
		// There is no crossproduct for 4D Vectors so just return a Vec3 and ignore w
		Vector3d CrossProduct(const Vector4d& rhs)
		{
			/*
			*        x y z
			*   this 1 2 3
	...
	inline bool operator==(const Vector4ui& lhs, const Vector4ui& rhs)
	{
		return lhs.x == rhs.x && lhs.y == rhs.y && lhs.z == rhs.z && lhs.w == rhs.w;
	}
